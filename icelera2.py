              ...
              #  print('fmt', fmt)
                ...
                while run:
                   ...
                   # print(data)
                    ...
                    if (time.time() - inicio_execucao >= 8 and time.time() - inicio_execucao <= 8.1):
                        print("***********Primeira Flexao***********")

                    if (time.time() - inicio_execucao >= 12 and time.time() - inicio_execucao <= 12.1):
                        print("+++++++++++Segunda Flexao++++++++++++")
            
                    if (time.time() - inicio_execucao >= 16 and time.time() - inicio_execucao <= 16.1):
                        print("-----------Terceira Flexao-----------")

                    if (time.time() - inicio_execucao >= 20 and time.time() - inicio_execucao <= 20.1):
                        print("***********Quarta Flexao***********")
                    
                    if (time.time() - inicio_execucao >= 24 and time.time() - inicio_execucao <= 24.1):
                        print("+++++++++++Quinta Flexao+++++++++++")

                    if (time.time() - inicio_execucao >= 28 and time.time() - inicio_execucao <= 28.1):
                        print("-----------Sexta Flexao-----------")

                    if (time.time() - inicio_execucao >= 32 and time.time() - inicio_execucao <= 32.1):
                        print("***********Setima Flexao***********")
            
                    if (time.time() - inicio_execucao >= 36 and time.time() - inicio_execucao <= 36.1):
                        print("+++++++++++Oitava Flexao+++++++++++")

                    if (time.time() - inicio_execucao >= 40 and time.time() - inicio_execucao <= 40.1):
                        print("-----------Nona Flexao-----------")
                    
                    if (time.time() - inicio_execucao >= 44 and time.time() - inicio_execucao <= 44.1):
                        print("***********Decima Flexao***********")

                    if (time.time() - inicio_execucao >= 48 and time.time() - inicio_execucao <= 48.1):
                        print("+++++++++++Decima Primeira Flexao+++++++++++")
                    
                    if (time.time() - inicio_execucao >= 52 and time.time() - inicio_execucao <= 52.1):
                        print("-----------Decima Segunda Flexao-----------")

                    if (time.time() - inicio_execucao >= 56 and time.time() - inicio_execucao <= 56.1):
                        print("-----------FIM-----------")
